...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F4EEFF] via-[#DCD6F7] to-[#A6B1E1] dark:from-gray-900 dark:via-[#424874] dark:to-gray-950">
      {/* Navigation */}
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8 py-6" aria-label="Main navigation">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-gradient-to-br from-[#A6B1E1] to-[#424874] rounded-lg flex items-center justify-center shadow-lg" aria-hidden="true">
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          <ul className="flex flex-wrap gap-6 justify-center items-center text-sm text-slate-600 dark:text-slate-400 pt-6" role="list">
        ...
        {/* Features Grid */}
        <section className="mt-32 max-w-6xl mx-auto" aria-labelledby="features-heading">
          <h2 id="features-heading" className="sr-only">Features</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <article className="group hover:shadow-2xl hover:shadow-[#A6B1E1]/20 transition-all duration-300 hover:-translate-y-2">
            <Card className="h-full border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur">
              <CardContent className="pt-8 space-y-4">
                <div className="w-14 h-14 bg-gradient-to-br from-[#A6B1E1] to-[#8B9FD9] rounded-2xl flex items-center justify-center shadow-lg shadow-[#A6B1E1]/30 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
          ...
          <article className="group hover:shadow-2xl hover:shadow-[#424874]/20 transition-all duration-300 hover:-translate-y-2">
            <Card className="h-full border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur">
              <CardContent className="pt-8 space-y-4">
                <div className="w-14 h-14 bg-gradient-to-br from-[#424874] to-[#333561] rounded-2xl flex items-center justify-center shadow-lg shadow-[#424874]/30 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
          ...
          <article className="group hover:shadow-2xl hover:shadow-[#DCD6F7]/20 transition-all duration-300 hover:-translate-y-2">
            <Card className="h-full border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur">
              <CardContent className="pt-8 space-y-4">
                <div className="w-14 h-14 bg-gradient-to-br from-[#DCD6F7] to-[#A6B1E1] rounded-2xl flex items-center justify-center shadow-lg shadow-[#DCD6F7]/30 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
          ...
          <article className="group hover:shadow-2xl hover:shadow-[#A6B1E1]/20 transition-all duration-300 hover:-translate-y-2">
            <Card className="h-full border-0 bg-white/80 dark:bg-gray-800/80 backdrop-blur">
              <CardContent className="pt-8 space-y-4">
                <div className="w-14 h-14 bg-gradient-to-br from-[#A6B1E1] to-[#424874] rounded-2xl flex items-center justify-center shadow-lg shadow-[#A6B1E1]/30 group-hover:scale-110 transition-transform duration-300" aria-hidden="true">
        ...
        {/* CTA Section */}
        <section className="mt-32 text-center max-w-3xl mx-auto" aria-labelledby="cta-heading">
          <div className="bg-gradient-to-r from-[#A6B1E1] via-[#8B9FD9] to-[#424874] rounded-3xl p-8 sm:p-12 shadow-2xl shadow-[#A6B1E1]/30">
            ...
            <Link href="/register">
              <Button 
                size="lg" 
                className="bg-white text-[#424874] hover:bg-white/90 text-lg px-8 py-6 shadow-xl hover:scale-105 transition-all duration-300 focus:ring-2 focus:ring-white focus:ring-offset-2"
                aria-label="Create your free QuickNotes account"
              >
      ...
      {/* Footer */}
      <footer className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 mt-20 border-t border-slate-200 dark:border-slate-800" role="contentinfo">
